...
![screenshot_382](https://github.com/user-attachments/assets/e750e952-ea3c-4a55-9dda-b37c09f7f7e7)
![screenshot_384](https://github.com/user-attachments/assets/640aa7ce-4023-4c67-a6e4-825a7fe1e64d)
...
Given:
- Each bcrypt guess costs ≈0.21 seconds (on my machine with 12 rounds).
- Suppose an attacker tries to brute-force a password from a space of size N.

If N = 10^6 (e.g., 6-digit numeric PIN):
   Expected time = 0.21 × 10^6 seconds ≈ 2.43 days

If N = 10^8 (e.g., lowercase 6-letter words):
   Expected time = 0.21 × 10^8 seconds ≈ 243 days

If N = 10^10 (e.g., alphanumeric 7-character):
   Expected time = 0.21 × 10^10 seconds ≈ 66.5 years

Conclusion: bcrypt's cost factor makes brute-forcing infeasible beyond tiny keyspaces, especially with salts disabling rainbow tables.
...
![Снимок экрана (385)](https://github.com/user-attachments/assets/c1f28071-c7d0-4109-bddf-bb815a33409c)
...
![Снимок экрана (393)](https://github.com/user-attachments/assets/b97d615a-1759-4a22-b786-007b5a094a92)
...
![Снимок экрана (394)](https://github.com/user-attachments/assets/0c77b313-a9b3-487d-b60b-3945991dd25b)
